...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn('py-16 md:py-20 bg-surface-subtle border-t border-border', className)}>
      <Container size="xl">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <Text size="sm" className="text-text-subdued mb-6 max-w-xs">
              Enterprise-grade project management for modern teams. Streamline
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <Text className="font-semibold text-text mb-4">{section.title}</Text>
